...
export interface Registry {
  ...
  'media.proxies': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['proxies']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['proxies']>>>
    }
  }
  'media.thumbnails': {
    methods: ["POST"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['thumbnails']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['thumbnails']>>>
    }
  }
  'media.starStates': {
    methods: ["POST"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['starStates']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['starStates']>>>
    }
  }
  'media.updateStar': {
    methods: ["PATCH"]
    ...
    types: {
      ...
      params: { hash: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['updateStar']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/media_assets_controller').default['updateStar']>>>
    }
  }
}
